        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{route('users.create')}}" class="slide-item">اضافه کردن کاربر جدید</a></li>
                        <li>
                            <a href="{{ route('users.index') }}" class="slide-item">  مشاهده لیست کاربران </a></li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)"><i
                            class="side-menu__icon fe fe-slack"></i><span
                            class="side-menu__label">  مدیریت پستها</span><i
                            class="angle fe fe-chevron-right"></i></a>
                    <ul class="slide-menu">
                        <li><a href="" class="slide-item">مشاهده همه پستها </a></li>
                        <li><a href="" class="slide-item">  ایجاد پست جدید</a></li>
